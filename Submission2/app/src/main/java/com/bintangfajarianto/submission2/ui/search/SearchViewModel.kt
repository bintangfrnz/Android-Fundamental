...
import com.bintangfajarianto.submission2.model.UserItem
...
class SearchViewModel : ViewModel() {
    ...
    private val _listUserItem = MutableLiveData<List<UserItem>>()
    val listUserItem: LiveData<List<UserItem>> = _listUserItem
...
//                _isLoading.value = false
                if (response.isSuccessful) {
                    ...
                    if (responseBody != null) {
                        ...
                        _listUserItem.value = responseBody.items
//                        getDetailUser()
                    }
                } else {
